  ...
  */
  ...
  for(long l=1;l<min_accuracy;l++) 
      ...
      for(long m=0;m<l;m++)//account of previous level
	{
      ...
      if(( (NTL::ZZ(1)<<(l+1))-tmp == 0) )//probabilites are rational
	{
	  /*
	    Since probabilities are rationals, their
	    expansions are exhaustively found.
	    No need of further zero coefficients.
	  */
	  break;
	}
    }
